...
CREATE TABLE `admin_menu` (
  ...
  `name_zh` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8_general_ci DEFAULT NULL,
  `icon_cls` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8_general_ci DEFAULT NULL,
